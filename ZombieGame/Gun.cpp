...
Gun::Gun(string name, int fireRate, int bulletsPerShot, float bulletSpeed, float bulletDamage, float bulletSpread, float bulletDuration) : m_name(name), m_fireRate(fireRate), m_bulletsPerShot(bulletsPerShot), m_bulletDamage(bulletDamage), m_bulletSpeed(bulletSpeed) , m_frameCounter(0), m_spread(bulletSpread), m_bulletDuration(bulletDuration)
{
}
